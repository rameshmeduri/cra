const blogPosts = [
  {
    ...
    description: 'Discover the happiness and companionship that comes with owning a dog.',
    tags: ['dog', 'happiness']
  },
  {
    id: 'b912d5c6674bb',
    title: 'Caring for Your Feline Friend',
    description: 'Learn how to provide the best care for your beloved cat (not caterpillar).',
  ...
  },
  {
    ...
    description: 'Discover effective techniques to train your dog and build a strong bond.',
    tags: ['dog', 'training']
  },
  {
    id: 'c631e68546bf3',
    title: 'Cat Breeds: Choosing the Perfect Companion',
    description: 'Find the ideal cat breed that matches your lifestyle and personality.',
    tags: ['cat', 'breeds']
  },
  {
    id: '0c2ef14638642',
    title: 'The Life Cycle of a Butterfly',
    description: "Learn about the stages of a butterfly's life and its importance in nature.",
    tags: ['caterpillar', 'butterfly']
  },
  {
    id: 'd75f1c4c29da1',
    title: 'Dog Health: Common Issues and Prevention',
    description: 'Discover how to keep your dog healthy and prevent common health problems.',
    tags: ['dog', 'health']
  },
  {
    id: '537c25b372465',
  ...
  },
  {
    ...
    description: 'Discover exciting activities to enjoy with your dog and create lasting memories.',
    tags: ['dog', 'activities']
  }
] as const;
...
function getColorFromSeed(seed: string, startIndex: number, length: number): string {
